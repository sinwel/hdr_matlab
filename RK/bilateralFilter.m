...
function [output out1] = bilateralFilter( data, edge, edgeMin, edgeMax, sigmaSpatial, sigmaRange, ...
    samplingSpatial, samplingRange )
...
%gridRSquared = ( gridZ .* gridZ ) / ( derivedSigmaRange * derivedSigmaRange );
